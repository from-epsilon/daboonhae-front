...
const ITEMS = [
  ...
  { label: '단백질 보충제', code: 'protein_supplement', img: `${IMG}/protein-supplements.jpg`, tab: 'protein' },
  { label: '쉐이크', code: 'shake', img: `${IMG}/shake.jpg`, tab: 'protein' },
        ...
        {ITEMS.map((item) => (
          ...
          >
            <span className="m-cat-icon">
              ...
              />
              {item.disabled && <span className="m-cat-soon">준비중</span>}
            </span>
