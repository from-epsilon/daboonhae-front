...
export const IconRocket = (p) => (
  <Icon
    ...
    d={
      <>
        <path d="M4.5 16.5c-1.2 1.2-1.5 3.4-1.5 3.4s2.2-.3 3.4-1.5c.7-.7.9-1.8.3-2.4-.6-.6-1.7-.4-2.2.5Z" />
        <path d="M9 15 6.8 12.8c-.4-.4-.5-1-.2-1.5C7.4 9.7 8.5 8 10 6.5 13.2 3.3 17.5 2.3 20.6 3.4c1.1 3.1.1 7.4-3.1 10.6-1.5 1.5-3.2 2.6-4.8 3.4-.5.3-1.1.2-1.5-.2L9 15Z" />
        <path d="M14 7h.01" />
        <path d="M8.5 13.5 6 16" />
