...
export const PROTEIN_DRINK_SORT_OPTIONS = [
  ...
  { key: 'eaa_total', label: '필수아미노산 총량 높은 순', short: 'EAA 총량' },
  { key: 'eaa_kcal', label: '필수아미노산 칼로리대비 높은 순', short: 'EAA/100kcal' },
  { key: 'eaa_price', label: '필수아미노산 가격대비 높은 순', short: 'EAA/1,000원' },
