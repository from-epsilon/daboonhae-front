...
function compareAscMissingLast(a, b, key) {
...
function compareDescMissingLast(a, b, key) {
  const av = numericValue(a, key);
  const bv = numericValue(b, key);
  if (av == null && bv == null) return 0;
  if (av == null) return 1;
