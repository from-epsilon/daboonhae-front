...
export const ALLERGEN_FILTER_NOTE =
  '법정 알레르기 표시 대상은 알류(가금류), 우유, 메밀, 땅콩, 대두, 밀, 고등어, 게, 새우, 돼지고기, 복숭아, 토마토, 아황산류(최종제품 SO₂ 10mg/kg 이상), 호두, 닭고기, 쇠고기, 오징어, 조개류(굴·전복·홍합 포함), 잣입니다. 그 외 성분은 데이터가 없어 제외 필터에서 누락될 수 있으니 실제 제품 표시를 확인해 주세요.';
