...
export function getListFilterSpecs({
  ...
  if (activeCode !== PROTEIN_DRINK_CODE) return ALL_FILTERS;
  return getProteinDrinkFilterSpecs(products, filterState, {
    proteinSourceLabelOf,
    sweetenerLabelOf,
  });
}
...
function rankedOptions(products, key, selected = {}, context = {}) {
  ...
  for (const product of products) {
    for (const item of new Set(getIngredientList(product, key, context))) {
